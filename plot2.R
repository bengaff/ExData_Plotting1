# Code used to create "plot2.png" file for Coursera Exploratory Data Analysis course project 1
...
# Plot 2 - Line chart for Global Active Power (kilowatts) by time in day
